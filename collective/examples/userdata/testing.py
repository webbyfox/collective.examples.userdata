...
class EnhancedUserdata(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        xmlconfig.file('configure.zcml', collective.examples.userdata, context=configurationContext)
        xmlconfig.file('configure.zcml', plone.formwidget.namedfile, context=configurationContext)
        xmlconfig.file('overrides.zcml', collective.examples.userdata, context=configurationContext)
